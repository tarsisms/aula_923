# **Programação Móvel - 923**

Projeto das aulas da disciplina de Programação Móvel da turma 923 - IFAL - campus Arapiraca.
...
```shell
823fcd5 (HEAD -> main) Aula 04 - Interfaces Gráficas - 17/03
...
5. Identifique a aula desejada e utilize o código apresentado para navegar até ela. Exemplo: desejo acessar a aula (a9604da Aula 06 - Interfaces Gráficas - 13/04). Desse modo, o comando ficaria da seguinte forma: `git checkout a9604da`
